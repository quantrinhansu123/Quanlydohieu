 ...
 */
export interface OrderInvoicePDFProps<T> {
 ...
 *   - dataTable: Dữ liệu bảng sản phẩm/dịch vụ
 *   - heads: Cấu hình cột cho bảng
 *   - option: Tùy chọn bổ sung (ví dụ: số hóa đơn tùy chỉnh)
 */
function OrderInvoicePDF<T extends Object>({
  financialCalculations,
  dataTable,
  heads,
  invoiceData,
  option
}: OrderInvoicePDFProps<T>) {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.title}>{t("invoiceDetails.orderInvoice.title") || "HÓA ĐƠN ĐẶT HÀNG"}</Text>
        ...
        <View style={styles.flexBetween}>
          ...
          <View>
            ...
            <View style={styles.flexBetween}>
              <Text style={styles.textBold}>{t("invoiceDetails.orderInvoice.orderDate") || "Ngày đặt hàng"}: </Text>
              <Text style={styles.textNormal}>
                {invoiceData.issueDate && dayjs(invoiceData.issueDate).format("DD/MM/YYYY")}
              </Text>
            </View>
        ...
        <Text style={styles.sectionTitle}>{t("invoiceDetails.orderInvoice.products") || "Sản phẩm/Dịch vụ đặt hàng"}</Text>
        ...
        <View style={styles.summaryContainer}>
          ...
          {/* Thông tin đặc biệt cho Order Invoice */}
          <View style={styles.summaryLine}>
            <Text style={styles.textBold}>{t("invoiceDetails.orderInvoice.expectedDelivery") || "Dự kiến giao hàng"}: </Text>
            <Text style={styles.textNormal}>
              {invoiceData.issueDate && dayjs(invoiceData.issueDate).add(7, "days").format("DD/MM/YYYY")}
            </Text>
          </View>
        </View>
